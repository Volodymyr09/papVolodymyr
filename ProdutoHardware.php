...
<div id="main" class="alt">
    ...
    <section id="one">
        <div class="inner">
            <header class="major">
                <h1>Motherboard ASUS B450-F Gaming</h1>
            </header>

            <div class="row">
                <div class="col-md-5">
                    <img src="images/ListaHardwareMotherboardAsusB450FGaming.jpg" class="img-responsive" alt="">
                </div>

                <div class="col-md-7">
                    <h2><del>1699.00</del>79.00</h2>

                    <p>(Socket AM4 - AMD B450 - ATX ).</p>
            ...
            <section>
                ...
                <form method="post" action="#">
                    <div class="fields">
                        ...
                        <div class="field half">
                            <label for="field-4">Performance:</label>
                        ...
                        <div class="field half">
                            <label for="field-5">Memória:</label>
                            <p>Drive: Não
