...
<div id="main" class="alt">
    ...
    <section id="one">
        <div class="inner">
            ...
            <div class="row">
                <div class="col-md-5">
                    <img src="images/PorAsusRogStrixG15.jpg" class="img-responsive" alt="">
                </div>

                <div class="col-md-7">
                    <h2><del>1699.00</del>79.00</h2>

                    <p>G512LU-70AT6PB1 (Intel Core i7-10750H - NVIDIA GeForce GTX 1660 Ti - RAM: 16 GB - 1 TB SSD - 15.6'').</p>
